...
import 'jui_form_radio_group.dart';
...
class JUIFormStyle {
  ...
  late double? titleBottomPadding;
...
// class JUIForm extends StatelessWidget {
//   final Widget child;
...
class JUIForm extends StatefulWidget {
  final Widget child;
  final JUIFormStyle? style;
  final JUIFormInputStyle? inputStyle;
  ...
  static JUIFormState? of(BuildContext context) =>
      context.findAncestorStateOfType<JUIFormState>();

  @override
  State<JUIForm> createState() => JUIFormState();
}

class JUIFormState extends State<JUIForm> {
  JUIFormStyle? config;
