...
// const _kDefaultProgressIndicatorStrokeWidth = 1.5;

// typedef JUIEasyRefreshController = er.EasyRefreshController;
// typedef EasyRefresh = er.EasyRefresh;
// typedef IndicatorResult = er.IndicatorResult;
// typedef IndicatorMode = er.IndicatorMode;
// typedef IndicatorPosition = er.IndicatorPosition;
// typedef IndicatorState = er.IndicatorState;

// /// 一个无延迟的极简 Header
// class ClassicHeader extends er.Header {
//   final Key? key;
...
//     er.SpringBuilder super.readySpringBuilder = er.kBezierSpringBuilder,
//     er.FrictionFactor super.frictionFactor = er.kBezierFrictionFactor,
//     super.safeArea,
...
// class InstantTriggerHeader extends er.Header {
//   final double height;

//   const InstantTriggerHeader({
//     this.height = 60,
...
//   @override
//   Widget build(BuildContext context, er.IndicatorState state) {
//     // 核心：只要准备好了，立刻进入 processing（触发 onRefresh）
//     if (state.mode == er.IndicatorMode.ready) {}

//     return Container(
//       height: height,
//       alignment: Alignment.center,
//       child: state.mode == er.IndicatorMode.processing
